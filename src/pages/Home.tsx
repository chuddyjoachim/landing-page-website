  ...
  return (
    <>
      <main className="w-full flex flex-row justify-center items-center">
        <div className="w-full max-w-1300">
          ...
          {/* top section -- intro */}
          <section className="w-full flex flex-col md:flex-row justify-center items-center mt-40">
            <div className="wrapper flex flex-col md:flex-row items-center justify-center w-11/12">
              <div className="left md:w-2/4 w-full flex flex-col items-center justify-center">
                <div className="wrap flex flex-col justify-center items-center break-1:items-start">
                  <h1 className="GT-Walsheim-Pro text-primary text-5xl font-bold mb-6">
                    Find a <span className="text-green-dark">job</span> easily
                  </h1>
                  <p className="Graphik w-5/6 text-center break-1:text-left font-medium text-base leading-loose tracking-widest">
                  ...
                  <div className="mt-7">
                    <h1 className="Graphik text-center break-1:text-left font-extrabold text-lg text-primary tracking-widest">
                      Trusted By:
                    </h1>
              ...
              <div className="right hidden md:flex w-2/4 flex-row">
                <div className="w-full relative flex flex-row justify-center items-center">
                  <img
                    src={customTopImg}
                    alt=""
                    className="w-3/4 absolute p-0"
                  />
                </div>
              </div>
            </div>
          ...
          <section
            id="Recommended-jobs"
            className="w-full flex flex-row justify-center mt-20 md:mt-40"
          >
          ...
          >
            <div className="wrapper flex flex-col-reverse lg:flex-row w-11/12">
              <div className="left-imgs w-full lg:w-3/5">
                <div className="img">
                  <img src={teamMd} alt="" />
                </div>
              </div>
              <div className="right-capt text-primary text-base font-normal">
                <div className="wrap flex-flex-col justify-start md:px-8">
                  ...
                  <ul>
                    <li className=" mb-8">
                      <div className="intro flex flex-row items-center mb-5">
                        <div className="icn text-green-light mr-3">
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="42"
                            height="34"
                      ...
                      <p className="">
                        ...
                        companies. Plus, you can create alerts so you never miss
                        a job opportunity.
                      </p>
                    </li>
                    <li className=" mb-8">
                      ...
                      <p className="">
                        ...
                        so recruiters can find you. Upload your CV so you can
                    ...
                    <li className=" mb-8">
                      ...
                      <p className="">
                        ...
                        visit our Career Center for tips and advice to build
                        your career.
                      </p>
                    </li>
                  </ul>
          ...
          >
            <div className="wrapper flex flex-col justify-center w-11/12">
              ...
              <div className="catWrap flex flex-row flex-wrap justify-between mt-5">
                {/* single category */}
                <div className="w-6/12 lg:w-1/5 border border-e5 rounded-xl">
          ...
          >
            <div className="wrapper relative flex flex-col justify-center w-11/12">
              ...
              <div className="wrapp py-16 px-8 flex flex-col md:flex-row items-center">
                <div className="left w-full md:w-1/2">
                  <div className="wrapp">
                    ...
                    <p className="my-6 Graphik font-medium text-primary tracking-wider">
                      ...
                      websites. We’re committed to accurate, high-quality jobs
                      so you won’t find old, duplicated, or spammy listings
                      here.
                    </p>
          ...
          >
            <div className="wrapper flex flex-col justify-center w-11/12">
              ...
              <div className="">
                <div className="wrapper flex flex-col-reverse md:flex-row md:items-center relative">
                  <div className="left w-auto md:w-80 left relative">
                  ...
                  <div className="right flex-1 relative md:px-8 py-4">
                    ...
                    <div className="flex flex-col justify-center w-11/12  Graphik text-primary font-bold text-lg tracking-wider">
                      <p className="">
                        ...
                        companies
                        {'&'} I have managed to secure 2 interviews already! I
            ...
            <div className="wrapper flex flex-col justify-center w-11/12">
              <div className="w-full relative">
                <div className="img relative">
                  <img src={banner1} alt="" />
                  <div className="content-cont absolute top-0 w-full h-full flex flex-row justify-center md:justify-end items-center">
                    <div className="content-wrapper w-full flex flex-col justify-center md:justify-start items-center md:max-w-lg">
                      <h1 className="text-xl md:text-3xl font-bold GT-Walsheim-Pro text-white tracking-widest">
                        Get a Job you actually like
                      </h1>
                      <p className="text-white py-2 md:py-5 tracking-wider font-semibold">
                        Create an account and start applying
                      </p>
                      <div className="">
                        <button className="text-sm md:text-base py-2 px-7 w-auto text-white rounded-50px bg-green-dark">
                          Get started
                        </button>
                      </div>
                    </div>
